...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			case 'gf':
				// GIRLFRIEND CODE
				tex = Paths.getSparrowAtlas('mindassets/GF_assetso');
				frames = tex;
			...
			case 'bf':
				var tex = Paths.getSparrowAtlas('mindassets/BOYFRIENDo');
				frames = tex;
			...
			case 'bob':
				frames = Paths.getSparrowAtlas('boblmao/bob_asset');
			...
			case 'bobmad':
				frames = Paths.getSparrowAtlas('boblmao/angrybob_asset');
				animation.addByPrefix('idle', 'bob_idle', 24, false);
				animation.addByPrefix('singUP', 'bob_UP', 24, false);
				animation.addByPrefix('singDOWN', 'bob_DOWN', 24, false);
			...
			case 'bobhell':
				frames = Paths.getSparrowAtlas('boblmao/hellbob_assets');
				animation.addByPrefix('idle', 'bobismad', 24, false);
				animation.addByPrefix('singUP', 'bobup', 24, false);
				animation.addByPrefix('singDOWN', 'bobdown', 24, false);
				animation.addByPrefix('singLEFT', 'bobleft', 24, false);
				animation.addByPrefix('singRIGHT', 'bobright', 24, false);
