...
class MenuCharacter extends FlxSprite
{
	private static var settings:Map<String, CharacterSetting> = [
		...
		'bob' => new CharacterSetting(0, 0, 1.0, true)
	];
	...
	public function new(x:Int, y:Int, scale:Float, flipped:Bool)
	{
		...
		frames = Paths.getSparrowAtlas('campaign_menu_UI_charactersBOB');
		...
		animation.addByPrefix('bob', "BOBBY BOBINO BOBBLE menu asset", 24);
